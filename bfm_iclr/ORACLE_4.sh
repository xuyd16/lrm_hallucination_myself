#!/bin/bash -l
#SBATCH --job-name=bfm_eeg_pretraining
...
cd /home/hk-project-p0022560/tum_fmp0582/ict/bfm_iclr || exit 1
...
export DATA_PATH="/home/hk-project-p0022560/tum_fmp0582/ict/bfm_iclr/processed_data1"
...
srun python -u train_slurm_1.py 2>&1 | tee "./logs/pretraining_${SLURM_JOB_ID}.log"
